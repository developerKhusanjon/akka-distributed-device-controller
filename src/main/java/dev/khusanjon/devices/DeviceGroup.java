...
public class DeviceGroup extends AbstractBehavior<DeviceGroup.Command> {
    ...
    private static class DeviceTerminated implements Command {
        ...
        private DeviceTerminated(ActorRef<Device.Command> device, String groupId, String deviceId) {
            this.device = device;
    ...
    private DeviceGroup(ActorContext<Command> context, String groupId) {
        ...
        context.getLog().info("DeviceGroup {} has started", groupId);
    }
    ...
    private DeviceGroup onTrackDevice(DeviceManager.RequestTrackDevice trackMsg) {
        if(this.groupId.equals(trackMsg.groupId)) {
            ...
            if (deviceActor != null)
                ...
                deviceActor =
                        getContext()
                                .spawn(Device.create(trackMsg.deviceId, groupId), "device-" + trackMsg.deviceId);
            ...
            getContext()
                    .getLog()
                    .warn("Ignoring TrackDevice request for {");
        return this;
    }

    private DeviceGroup onDeviceList(DeviceManager.RequestDeviceList l) {
        l.replyTo.tell(new DeviceManager.ReplyDeviceList(l.requestId, deviceIdToActor.keySet()));
        return this;
    }
